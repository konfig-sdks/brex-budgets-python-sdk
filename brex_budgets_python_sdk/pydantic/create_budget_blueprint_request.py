...
from brex_budgets_python_sdk.pydantic.create_budget_blueprint_request_owner_user_ids import CreateBudgetBlueprintRequestOwnerUserIds
...
class CreateBudgetBlueprintRequest(BaseModel):
    ...
    owner_user_ids: typing.Optional[CreateBudgetBlueprintRequestOwnerUserIds] = Field(None, alias='owner_user_ids')
