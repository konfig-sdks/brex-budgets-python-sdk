...
from brex_budgets_python_sdk.model.page_budget import PageBudget as PageBudgetSchema

from brex_budgets_python_sdk.type.page_budget import PageBudget

from ...api_client import Dictionary
from brex_budgets_python_sdk.pydantic.page_budget import PageBudget as PageBudgetPydantic
...
SchemaFor200ResponseBodyApplicationJson = PageBudgetSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return PageBudgetPydantic(**raw_response.body)
        return api_client.construct_model_instance(PageBudgetPydantic, raw_response.body)
