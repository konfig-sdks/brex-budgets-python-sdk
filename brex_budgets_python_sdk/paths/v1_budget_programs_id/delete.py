...
class BaseApi(api_client.Api):
    ...
    def _remove_program_by_id_mapped_args(
        self,
        id: str,
    ...
    async def _aremove_program_by_id_oapg(
        self,
    ...
    def _remove_program_by_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveProgramByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_program_by_id(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_program_by_id_mapped_args(
            id=id,
        )
        return await self._aremove_program_by_id_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_program_by_id(
        self,
        id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._remove_program_by_id_oapg(
            path_params=args.path,
        )

class RemoveProgramById(BaseApi):
    ...
    async def aremove_program_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_program_by_id(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def remove_program_by_id(
        ...
        raw_response = self.raw.remove_program_by_id(
            id=id,
        )
        if validate:
            return BudgetProgramPydantic(**raw_response.body)
